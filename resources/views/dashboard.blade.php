        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-50">
                ...
                <tr class="hover:bg-gray-50 transition">
                    <td class="px-6 py-3 font-mono font-bold text-sm"
                        style="color:#16a34a;">
...
{{-- Tabel booking terbaru untuk resepsionis --}}
<div class="bg-white rounded-2xl border border-gray-100">
    <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
        <h3 class="font-semibold text-gray-800">Booking Perlu Perhatian</h3>
        <a href="{{ route('resepsionis.bookings.index') }}"
           class="text-xs font-medium hover:underline"
           style="color:#16a34a;">
            Lihat semua →
...
{{-- ==========================================
     ADMIN FNB DASHBOARD
     Konten khusus FnB — tidak ada tabel booking
========================================== --}}
@role('admin_fnb')
        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-50">
                ...
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="px-6 py-3 text-gray-600">
                        {{ $order->booking->room->room_number ?? '-' }}
                    </td>
