...
============================================ --}}
    <nav class="fixed top-0 left-0 right-0 z-50 navbar-blur border-b border-gray-100" x-data="{ scrolled: false }"
        x-init="window.addEventListener('scroll', () => { scrolled = window.scrollY > 20 })" :class="scrolled ? 'shadow-sm' : ''">
        <div class="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
            ...
            <div class="hidden md:flex items-center gap-6">
                <a href="#fasilitas"
                    class="text-sm text-gray-500 hover:text-green-600 transition font-medium">Fasilitas</a>
...
============================================ --}}
    <section class="relative min-h-screen flex items-center justify-center overflow-hidden pt-20"
        ...
        <div class="particle w-1.5 h-1.5" style="bottom:5%; left:35%; animation-delay:1.5s; animation-duration:4.5s;">
        </div>
        <div class="particle w-2.5 h-2.5" style="bottom:15%; left:60%; animation-delay:3s; animation-duration:6s;">
        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-8 mt-12 animate-fade-up delay-400">
                        @foreach ([['num' => '50+', 'label' => 'Kamar Premium'], ['num' => '98%', 'label' => 'Kepuasan Tamu'], ['num' => '24/7', 'label' => 'Layanan Kami']] as $stat)
                            <div>
                ...
                <div class="hidden lg:block animate-fade-up delay-300">
                    <div class="relative">
                        ...
                        <div
                            class="absolute -top-4 -right-4 bg-green-500 text-white text-xs font-bold
                        ...
                        <div
                            class="absolute -bottom-4 -left-4 bg-white rounded-2xl p-3 shadow-xl animate-float delay-400">
                            <div class="flex items-center gap-2">
                                <div
        ...
        <div class="absolute bottom-0 left-0 right-0">
            <svg viewBox="0 0 1440 80" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    d="M0 80L60 74C120 68 240 56 360 50C480 44 600 44 720 47C840 50 960 56 1080 56C1200 56 1320 50 1380 47L1440 44V80H1380C1320 80 1200 80 1080 80C960 80 840 80 720 80C600 80 480 80 360 80C240 80 120 80 60 80H0Z"
                    fill="white" />
            </svg>
        </div>
    </section>
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                @php
                    ...
                    $fasilitasHotel = [
                        ...
                        [
                            'icon' => 'ti-swimming-pool',
                            'name' => 'Kolam Renang',
                            'desc' => 'Outdoor pool dengan pemandangan indah',
                        ],
                        [
                            'icon' => 'ti-tools-kitchen-2',
                            'name' => 'Restoran',
                            'desc' => 'Sajian kuliner lokal & internasional',
                        ],
                        ['icon' => 'ti-car', 'name' => 'Free Parkir', 'desc' => 'Area parkir luas & aman'],
                        [
                            'icon' => 'ti-air-conditioning',
                            'name' => 'AC Central',
                            'desc' => 'Suhu nyaman di semua ruangan',
                        ],
                        [
                            'icon' => 'ti-first-aid-kit',
                            'name' => 'Klinik 24 Jam',
                            'desc' => 'Layanan kesehatan siap membantu',
                        ],
        ...
        <div class="max-w-6xl mx-auto px-4">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="reveal">
                    ...
                    {{-- List keunggulan --}}
                    <div class="space-y-4">
                        @foreach ([['icon' => 'ti-shield-check', 'title' => 'Keamanan Terjamin', 'desc' => 'CCTV 24 jam dan security profesional'], ['icon' => 'ti-star', 'title' => 'Pelayanan Bintang 5', 'desc' => 'Staff terlatih siap melayani dengan sepenuh hati'], ['icon' => 'ti-map-pin', 'title' => 'Lokasi Strategis', 'desc' => 'Mudah dijangkau dari pusat kota'], ['icon' => 'ti-thumb-up', 'title' => 'Harga Terjangkau', 'desc' => 'Kualitas premium dengan harga yang bersahabat']] as $item)
                ...
                <div class="grid grid-cols-2 gap-4 reveal">
                    @foreach ([['num' => '500+', 'label' => 'Tamu Puas', 'icon' => 'ti-users', 'color' => '#16a34a'], ['num' => '50+', 'label' => 'Kamar Premium', 'icon' => 'ti-building', 'color' => '#2563eb'], ['num' => '10+', 'label' => 'Tahun Pengalaman', 'icon' => 'ti-award', 'color' => '#d97706'], ['num' => '4.9', 'label' => 'Rating Tamu', 'icon' => 'ti-star-filled', 'color' => '#dc2626']] as $stat)
                        ...
                        <div class="relative overflow-hidden" style="padding-top: 62%;">
                            <div class="absolute inset-0">
                                ...
                                <div class="absolute top-4 left-4">
                                    <span
                                        class="px-3 py-1.5 rounded-full text-xs font-bold bg-white text-gray-700 shadow-lg">
                                        {{ $room->category->name ?? '-' }}
                                    </span>
                                </div>
        ...
        <div class="max-w-6xl mx-auto px-4">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="reveal">
                    ...
                    <div class="space-y-4">
                        @foreach ([['icon' => 'ti-phone', 'label' => 'Telepon', 'value' => '+62 812 3456 7890'], ['icon' => 'ti-mail', 'label' => 'Email', 'value' => 'info@paijohotel.com'], ['icon' => 'ti-map-pin', 'label' => 'Alamat', 'value' => 'Jl. Paijo No. 1, Kota Impian'], ['icon' => 'ti-clock', 'label' => 'Jam Buka', 'value' => '24 Jam / 7 Hari']] as $kontak)
